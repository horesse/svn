        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<AppInfo>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AppInfo>;
        }));
    }

    protected processGetAppInfo(response: HttpResponseBase): Observable<AppInfo> {
...
export interface IIdentityClient {
    login(command: LoginQuery): Observable<AuthResponse>;
...
export class IdentityClient implements IIdentityClient {
    ...
    getUserAvatar(): Observable<string> {
        let url_ = this.baseUrl + "/api/Identity/avatar";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserAvatar(response_ as any);
                } catch (e) {
